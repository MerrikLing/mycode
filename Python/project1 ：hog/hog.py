...
def make_averaged(original_function, trials_count=1000):
    ...
    def f(*a):
        ...
        for i in range(1,trials_count+1):
            b += original_function(*a)
        return b/  trials_count
    return f
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    a=0
    for i in range(1,11):
        b=make_averaged(roll_dice, total_samples)(i,dice)
        if b>a:
            a=b ; c=i
    return c
...
def swine_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    b=swine_swap(a+score)
    if b and opponent_score - score>=threshold:
        return 0
    if a>=threshold and not b:
        return 0
    return num_rolls
    # END PROBLEM 11
